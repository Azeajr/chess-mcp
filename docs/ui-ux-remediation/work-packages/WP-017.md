...
**Blocking gates.** None. DV-3 is fixed: Save remains visible; Open, Re-link, New, and Recover move into the menu.
...
Regression mode: Save or New becomes unreachable through its fixed path. Detection: visible-without-menu and ≤2-interaction assertions. Rollback: single-file revert.
