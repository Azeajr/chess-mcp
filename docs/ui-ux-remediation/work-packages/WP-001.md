...
Typecheck green; baseline check 1 passes on all three browsers; phone baseline and scripted visual-viewport assertions are green at the 200% equivalent and landscape sizes.
