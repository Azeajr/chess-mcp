...
8. Interlink the repertoire: find_transposition_opportunities → move-order bridges (frontier_link = extend a stopped line 1 ply into existing prep; move_order_merge = an alternate order; coverage_confirmed = an opponent try already covered). Engine-free; the link is sound by construction (it lands in your own prep).
