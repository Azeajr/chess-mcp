...
const PROFILE_OPTIONS: readonly {
...
}[] = [
  {
    mode: "familiar-plans",
    description:
      "Prefer fewer unique structures and plans, accepting less variety to reduce learning load.",
  },
  {
    mode: "balanced",
  ...
  },
  {
    mode: "versatile",
    description:
      "Preserve more strategic diversity, accepting more structures and plans to remember.",
  },
  {
    mode: "custom",
  ...
  return (
    <main class="strategic-fit-profile-setup" aria-labelledby="strategic-fit-profile-setup-title">
      <form onSubmit={submit}>
        ...
        <fieldset
          class="strategic-fit-profile-options"
          aria-describedby="strategic-fit-profile-setup-description"
        >
          <legend class="sr-only">Review profile</legend>
          <For each={PROFILE_OPTIONS}>
            {(option) => (
              <label
                class={`strategic-fit-profile-option${selectedMode() === option.mode ? " selected" : ""}`}
              >
                <input
                  type="radio"
        ...
        >
          ...
          <div class="strategic-fit-profile-fields">
              ...
              {(family) => (
                <label>
                  ...
                  <span class="strategic-fit-field-help">
                    0 ignores this family; 1 is standard; 3 gives it the strongest influence on
                    strategic distance.
                  </span>
            ...
            <label>
              ...
              <span class="strategic-fit-field-help">
                Comma-separated concept identifiers or names.
              </span>
              <input
                type="text"
