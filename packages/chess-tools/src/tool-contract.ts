...
export const TOOL_CONTRACTS = [
  ...
  define("suggest_gap_fills", "Build best-evaluation and best-fit repertoire lines for one uncovered opponent move.", ["repertoire", "engine"], BOTH, { depth: 16, limit: 4 }, { properties: { repertoire_id: string("MCP handle; browser injects the current document"), variation_path: array(), uncovered_move: string(), depth: integer(1, 30), limit: integer(2, 10), target_plies: integer(2, 200) }, required: ["variation_path", "uncovered_move"], mcpRequired: ["repertoire_id", "variation_path", "uncovered_move"] }),
